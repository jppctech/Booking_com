"use client";
import { Bars3Icon,ChatBubbleBottomCenterIcon,ChevronDownIcon,HomeIcon,PaperAirplaneIcon,PhoneIcon,PlayCircleIcon,XMarkIcon } from "@heroicons/react/16/solid";
...
function Header() {
    ...
    <nav
    className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:scroll-px-8"
    aria-label="Global">
       ...
       <div className="flex lg:hidden">
        <button
        type="button"
        className="m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-white" onClick={
       ...
       <Popover.Group className="hidden lg:flex lg:gap-x-12">
        <Popover className="relative">
            <Popover.Button className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-white">
                Stays
                <ChevronDownIcon
                className="h-5 w-5 flex-none text-white outline-none"
                aria-hidden="true"/>
            </Popover.Button>

            <Transition 
            as={Fragment}
            enter="transition ease-out during-200"
            enterFrom="opacity-0 translate-y-1"
            enterTo="opacity-100 translate-y-0"
            leave="transition ease in durind-150"
        ...
        <a href="#" className="text-sm font-semibold leading-6 text-white">Flight</a>
        <a className="text-sm font-semibold leading-6 text-white">Car Rentals</a>
        <a className="text-sm font-semibold leading-6 text-white">Attractions</a>
        <a className="text-sm font-semibold leading-6 text-white">Flight + Hotel</a>
       </Popover.Group>
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              ...
              <div>
                <a 
                href="#"
                className="-m-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-white hover:bg-blue-800">
                    Log In
                </a>
              </div>
            </div>
